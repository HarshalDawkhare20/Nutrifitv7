  ...
  return (
    <div className="p-3 mb-2  ">
      <div className="container">
        {/* <!-- into start --> */}
        <div
          className="row  py-5 valuecard"
          style={{ backgroundColor: "rgba(243, 243, 243, 0.3)" }}
        >
          <div className="col-sm-6  d-flex flex-column justify-content-center ">
            <h1 className="fw-bold py-2 m-2">Web Squad'5' Presents</h1>
            <h3 className="fw-normal m-2">
              Want to understand the fundamental of good nutrition & How food
              Fuels your body then
              <br />
            ...
            <span className="py-3 m-2">
              <button
                ...
                type="button"
                className="btn btn-primary rmdbut rounded-1 grnbtn shadow "
              >
                Read More{" "}
              </button>
              <button
                ...
                type="button"
                className="btn btn-primary rmdbut rounded-1 difbtn mx-3 shadow-lg"
              >
                Get Started{" "}
              </button>
            </span>
        ...
        >
          ...
          <div className="col-sm-5  d-flex flex-column justify-content-center">
            ...
            <h4 className="fw-bold py-2">
              We are Third year enthusiast Engineering Students having ignited
              minds creating our first ever site that will help alot of people
            </h4>
            <p>
              Hola peeps ! you are at right place.Nutri-Fit provides you all
              nutrition facts. from fruits and vegetables to whole grains,
              understanding different nutritional values helps you make educated
              nutrition choices
            </p>
          </div>
        </div>
        ...
        >
          <div className="col-sm-12  d-flex flex-column justify-content-center text-center">
            ...
            <h4 className="fw-bold py-2">
              Get Nutrishnal value by seraching food
            </h4>
            <div className="row">
              <div className="col-sm-3"></div>
              <div className="col-sm-6">
                Nutri-Fit’s Food Nutrition Calculator allows you to choose from
                thousands of foods and brands, and see nutrition facts such as
                calories, fat, protein, carbohydrates, fiber and sugar. Get
                started by entering your food and.
              </div>
              <div className="col-sm-3"></div>
            </div>
          ...
          <div className="row">
            <div className="col-md-12 my-4">
              ...
              <h3 className="fw-bold">
                So ! What Problems does it solve and what makes it different ?{" "}
              </h3>
            </div>
          </div>
              ...
              <div className="card h-100 border-0 shadow valuecard">
                ...
                <div className="card-body">
                  <h5 className="card-title">
                    Provides Fundamentals of Good Nutrition
                  </h5>
                  <p className="card-text">
                    We provides fundamentals of good nutrition that can help you
                    make smarter decisions and build meals that nourish your
                    day..
                  </p>
                </div>
              </div>
            ...
            <div className="col ">
              <div className="card h-100 border-0 shadow valuecard">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Technology has evolved so far inorder to solve this problem
                    so does this site does .
                  </p>
                </div>
              </div>
            </div>
            <div className="col ">
              <div className="card h-100 border-0 shadow valuecard">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    No need to scroll on different websites for health news , we
                    provide evidence based news at one place
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="text-center mt-5 ">
            <div className="copyright">
              &copy; Copyright{" "}
              <strong>
                <span>Web Squad'5'</span>
              </strong>
              . All Rights Reserved |{" "}
              <a className="blulink" onClick={() => navigate("/help")}>
                Help
              </a>
            </div>
          </div>
